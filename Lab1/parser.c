...
{
  "$end", "error", "$undefined", "TOKEN_BOOL", "TOKEN_BVEC2",
  "TOKEN_BVEC3", "TOKEN_BVEC4", "TOKEN_INT", "TOKEN_IVEC2", "TOKEN_IVEC3",
  "TOKEN_IVEC4", "TOKEN_FLOAT", "TOKEN_VEC2", "TOKEN_VEC3", "TOKEN_VEC4",
  "TOKEN_VARIABLE", "TOKEN_INTEGER_VAL", "TOKEN_IDENTIFIER", "TOKEN_LIT",
  "TOKEN_RSQ", "TOKEN_DP3", "TOKEN_IF", "TOKEN_ELSE", "TOKEN_WHILE",
  "TOKEN_TRUE", "TOKEN_FALSE", "TOKEN_PLUS", "TOKEN_MINUS", "TOKEN_MUL",
  "TOKEN_DIV", "TOKEN_EXP", "TOKEN_NOT", "TOKEN_AND", "TOKEN_OR",
  "TOKEN_EQUAL", "TOKEN_NOT_EQUAL", "TOKEN_LTHAN", "TOKEN_LTHAN_EQUAL",
  ...
  "TOKEN_CLOSE_SQB", "TOKEN_COMMA", "$accept", "program", "tokens",
  "token", YY_NULLPTR
};
#endif
...
{
       4,     0,     2,     1,     5,     6,     7,     8,     9,    11,
      10,    12,    14,    13,    16,    15,    20,    18,    17,    19,
      21,    22,    26,    24,    23,    25,    27,    28,    29,    31,
